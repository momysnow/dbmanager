...
class DashboardStats:
    ...
    def get_overview_stats(self) -> Dict[str, Any]:
        ...
        s3_buckets = self.config_manager.config.get("s3_buckets", [])
    ...
    def get_database_stats(self) -> List[Dict[str, Any]]:
        ...
        for db in databases:
            ...
            stats.append({
                ...
                "schedule_cron": active_schedule.get('cron_expression') if active_schedule else None,
    ...
    def get_storage_breakdown(self) -> Dict[str, Any]:
        ...
        for item in breakdown:
            item['percentage'] = (item['size_mb'] / total_size * 100) if total_size > 0 else 0
    ...
    def get_health_status(self) -> Dict[str, Any]:
        ...
        for db in databases:
            ...
            if not backups:
                ...
                days_old = (datetime.now() - last_backup['date']).days
            ...
            # No schedule
            schedules = self.config_manager.config.get("schedules", [])
            db_schedules = [s for s in schedules if s.get('database_id') == db_id and s.get('enabled')]
